...
class _ReadScriptureScreenState extends State<ReadScriptureScreen> {
  ...
  Future<void> _startAt(int chapter, {int? verse}) async {
    ...
    try {
      final bookId = _bibleText.bookIdFor(book);
      final translationLabel = BibleTextService.translations[_translation] ?? _translation;
  ...
  Widget _buildBookPicker(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Read Scripture')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: BibleTextService.translations.entries
